public class Numbers {
    ...
    }//Validando la formula, estaba incompleta

    private static double iterative(double z, double n) {//Gemini
        if (n <= 1) {
            return 1;
        }
    ...
    private static double round(double value) {//error #1
